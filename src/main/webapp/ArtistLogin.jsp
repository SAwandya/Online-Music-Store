  ...
  <div class="container py-5 h-100">
    <div class="row d-flex align-items-center justify-content-center h-100">
      ...
      <c:if test="${not empty requestScope.errorMessage}">
        ...
        <form method="post" action="ValidateArtistServlet">
          <!-- Email input -->
         ...
         <a class="btn btn-primary btn-lg btn-block" style="background-color: #3b5998" href="http://localhost:8090/MusicStore/main"
            role="button">
